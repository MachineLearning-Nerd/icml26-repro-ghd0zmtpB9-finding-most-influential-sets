...
---
<!-- trackio-cell
{"type": "code", "id": "cell_41d1e92f9357", "created_at": "2026-07-17T05:04:49+00:00", "title": "Finite termination and million-row top-k scaling", "command": ["python", "repro/src/run_fmis.py"], "exit_code": 0, "duration_s": 9.964}
-->
````bash
...
Official findingMIS reproduction complete
{
  ...
  "claim2_finite_topk_algorithm": {
    ...
    "independent_expected_linear_topk_scaling": [
      {
        "n": 10000,
        "seconds": 0.0007861880585551262,
        "iterations": 3
      },
      {
        "n": 100000,
        "seconds": 0.01801266917027533,
        "iterations": 2
      },
      {
        "n": 1000000,
        "seconds": 0.13867437792941928,
        "iterations": 2
      }
    ],
    "largest_n": 1000000,
...
---
<!-- trackio-cell
{"type": "artifact", "id": "cell_bc009709d906", "created_at": "2026-07-17T05:04:49+00:00", "title": "Artifact: official_case_data.csv", "path": "outputs/official_case_data.csv", "size": 65110, "artifact_type": "dataset", "auto": true}
-->
...
---
<!-- trackio-cell
{"type": "artifact", "id": "cell_43c65190fc7c", "created_at": "2026-07-17T05:04:49+00:00", "title": "Artifact: official_separation.csv", "path": "outputs/official_separation.csv", "size": 14488, "artifact_type": "dataset", "auto": true}
-->
...
---
<!-- trackio-cell
{"type": "artifact", "id": "cell_cf157e969026", "created_at": "2026-07-17T05:04:49+00:00", "title": "Artifact: official_cases.csv", "path": "outputs/official_cases.csv", "size": 8095, "artifact_type": "dataset", "auto": true}
-->
...
---
<!-- trackio-cell
{"type": "artifact", "id": "cell_9424e09f7455", "created_at": "2026-07-17T05:04:49+00:00", "title": "Artifact: official_scaling.csv", "path": "outputs/official_scaling.csv", "size": 255, "artifact_type": "dataset", "auto": true}
-->
**📦 Artifact** `outputs/official_scaling.csv` · dataset · 255 B
...
---
<!-- trackio-cell
{"type": "artifact", "id": "cell_007889ba1784", "created_at": "2026-07-17T05:04:49+00:00", "title": "Artifact: official_realdata.csv", "path": "outputs/official_realdata.csv", "size": 176, "artifact_type": "dataset", "auto": true}
-->
...
---
<!-- trackio-cell
{"type": "markdown", "id": "cell_fec59b3f0dd5", "created_at": "2026-07-17T05:04:49+00:00", "title": "Verdict"}
-->
The unmodified released Rcpp heap implementation finishes `n=1,000,000`, `k=100` in `0.0572 s` and two Dinkelbach updates. The paper explicitly permits heap top-k (`O(n log k)`) as an implementation alternative. A separately implemented expected-linear top-k version matches all 120 exact results and completes the same scale in `0.0993 s`. The bundled 1,599-row wine dataset run takes two updates.
