...
---
<!-- trackio-cell
{"type": "code", "id": "cell_28585d6dd4ee", "created_at": "2026-07-17T05:05:00+00:00", "title": "Oracle residualization and generated-score separation sweep", "command": ["python", "repro/src/run_fmis.py"], "exit_code": 0, "duration_s": 9.947}
-->
````bash
...
Official findingMIS reproduction complete
{
  ...
  "claim2_finite_topk_algorithm": {
    "official_scaling": [
      {
        "n": 1000,
        "k": 100,
        "seconds": 0.000800000000000089,
        "iterations": 3
      },
      {
        "n": 10000,
        "k": 100,
        "seconds": 0.000999999999999979,
        "iterations": 3
      },
      {
        "n": 100000,
    ...
    "independent_expected_linear_topk_scaling": [
      {
        "n": 10000,
        "seconds": 0.0007900139316916466,
        "iterations": 3
      },
      {
        "n": 100000,
        "seconds": 0.0067569168750196695,
        "iterations": 2
      },
      {
        "n": 1000000,
        "seconds": 0.06837737280875444,
        "iterations": 2
      }
    ],
    "largest_n": 1000000,
...
---
<!-- trackio-cell
{"type": "artifact", "id": "cell_9c86c723c2d5", "created_at": "2026-07-17T05:05:00+00:00", "title": "Artifact: official_case_data.csv", "path": "outputs/official_case_data.csv", "size": 65110, "artifact_type": "dataset", "auto": true}
-->
...
---
<!-- trackio-cell
{"type": "artifact", "id": "cell_0b4bd73496a2", "created_at": "2026-07-17T05:05:00+00:00", "title": "Artifact: official_separation.csv", "path": "outputs/official_separation.csv", "size": 14488, "artifact_type": "dataset", "auto": true}
-->
...
---
<!-- trackio-cell
{"type": "artifact", "id": "cell_1b36050fa95e", "created_at": "2026-07-17T05:05:00+00:00", "title": "Artifact: official_cases.csv", "path": "outputs/official_cases.csv", "size": 8095, "artifact_type": "dataset", "auto": true}
-->
...
---
<!-- trackio-cell
{"type": "artifact", "id": "cell_16e900756c49", "created_at": "2026-07-17T05:05:00+00:00", "title": "Artifact: official_scaling.csv", "path": "outputs/official_scaling.csv", "size": 256, "artifact_type": "dataset", "auto": true}
-->
**📦 Artifact** `outputs/official_scaling.csv` · dataset · 256 B
...
---
<!-- trackio-cell
{"type": "artifact", "id": "cell_86a00507fbef", "created_at": "2026-07-17T05:05:00+00:00", "title": "Artifact: official_realdata.csv", "path": "outputs/official_realdata.csv", "size": 176, "artifact_type": "dataset", "auto": true}
-->
...
---
<!-- trackio-cell
{"type": "markdown", "id": "cell_92bed50433f7", "created_at": "2026-07-17T05:05:01+00:00", "title": "Verdict"}
-->
For 25 independent PLM-style oracle residualized instances, exact oracle MIS recovery is **100%** through perturbation `1e-4`, with a positive minimum separation gap `2.17e-4`. Recovery falls to 96% at `1e-3` and `1e-2`, as perturbation approaches the gap. This is direct finite evidence for the theorem’s conditional generated-score/separation mechanism; it is not portrayed as a universal proof of an asymptotic theorem.
